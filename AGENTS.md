...
## Design Rules
- **Section Headers**: Consistently place the blue separator line (`<div class="w-16 h-1 bg-primary mx-auto my-4 rounded-full"></div>`) immediately AFTER the main heading/title, and BEFORE the description/subtitle across the site.
